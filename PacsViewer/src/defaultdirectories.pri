...
SDK_INSTALL_PREFIX = /Users/bitter/Documents/
isEmpty(SDK_INSTALL_PREFIX){
    unix:SDK_INSTALL_PREFIX = $$(SDK_INSTALL_PREFIX)/SDK/
...
isEmpty(DCMTKLIBDIR){
    unix:DCMTKLIBDIR    = /Users/bitter/Documents/SDK/DCMTK/dcmtk-3.6.5S/lib#$$SDK_INSTALL_PREFIX/DCMTK/lib
...
isEmpty(DCMTKINCLUDEDIR){
    unix:DCMTKINCLUDEDIR = /Users/bitter/Documents/SDK/DCMTK/include#$$SDK_INSTALL_PREFIX/DCMTK/dcmtk-3.6.9
...
VTKLIBDIR = $$(VTKLIBDIR)
isEmpty(VTKLIBDIR){
    unix:VTKLIBDIR =  /Users/bitter/Documents/SDK/VTK/VTK-9.4.0S/lib/lib#$$SDK_INSTALL_PREFIX/lib
    win32:VTKLIBDIR = $$SDK_INSTALL_PREFIX/VTK_8.2.0_lib
}
VTKINCLUDEDIR = $$(VTKINCLUDEDIR)
isEmpty(VTKINCLUDEDIR){
    unix:VTKINCLUDEDIR     = /Users/bitter/Documents/SDK/VTK/include#$$SDK_INSTALL_PREFIX/include/vtk-8.1
...
ITKLIBDIR = $$(ITKLIBDIR)
isEmpty(ITKLIBDIR){
    unix:ITKLIBDIR = /Users/bitter/Documents/SDK/ITK/ITK-5.3.0S/lib#$$SDK_INSTALL_PREFIX/lib
    win32:ITKLIBDIR = $$SDK_INSTALL_PREFIX/ITK_5.3.0_lib
}
ITKINCLUDEDIR = $$(ITKINCLUDEDIR)
isEmpty(ITKINCLUDEDIR){
    unix:ITKINCLUDEDIR     = /Users/bitter/Documents/SDK/ITK/include#$$SDK_INSTALL_PREFIX/include/ITK-4.13
...
isEmpty(GDCMLIBDIR){
    unix:GDCMLIBDIR = /Users/bitter/Documents/SDK/GDCM/GDCM-3.0.23S/bin #$$SDK_INSTALL_PREFIX/lib
...
isEmpty(GDCMINCLUDEDIR){
    unix:GDCMINCLUDEDIR = /Users/bitter/Documents/SDK/GDCM/include
...
isEmpty(THREADWEAVERLIBDIR){
    ...
    macx:THREADWEAVERLIBDIR =  /Users/bitter/Documents/SDK/Threadweaver/threadweaver-5.46.0S/src #$$SDK_INSTALL_PREFIX/lib
...
isEmpty(THREADWEAVERINCLUDEDIR){
    unix:THREADWEAVERINCLUDEDIR     = /Users/bitter/Documents/SDK/Threadweaver/include##$$SDK_INSTALL_PREFIX/include/KF5
