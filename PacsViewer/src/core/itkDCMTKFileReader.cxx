...
int DCMTKItem::GetElementSQ(unsigned short group,
...
int DCMTKSequence::GetStack(unsigned short group,
...
int DCMTKSequence::card()
{
    return this->m_DcmSequenceOfItems->card();
}

int DCMTKSequence::GetSequence(unsigned long index,
...
int DCMTKSequence::GetElementCS(unsigned short group,
               unsigned short element,
               std::string &target,
               bool throwException)
{
...
int DCMTKSequence::GetElementOB(unsigned short group,
               unsigned short element,
               std::string &target,
               bool throwException)
{
...
int DCMTKSequence::GetElementCSorOB(unsigned short group,
                   unsigned short element,
                   std::string &target,
                   bool throwException)
{
...
int DCMTKSequence::GetElementFD(unsigned short group,
             unsigned short element,
             int count,
             double * target,
             bool throwException)
...
int DCMTKSequence::GetElementDS(unsigned short group,
               unsigned short element,
               std::string &target,
               bool throwException)
{
...
int DCMTKSequence::GetElementSQ(unsigned short group,
               unsigned short element,
               DCMTKSequence &target,
               bool throwException)
{
...
int DCMTKSequence::GetElementItem(unsigned short index,
                 DCMTKItem &target,
                 bool throwException)
{
...
int DCMTKSequence::GetElementTM(unsigned short group,
               unsigned short element,
               std::string &target,
               bool throwException)
{
...
int DCMTKFileReader::GetElementLO(unsigned short group,
               unsigned short element,
               std::string &target,
               bool throwException)
{
...
int DCMTKFileReader::GetElementFD(unsigned short group,
               unsigned short element,
               int count,
               double * target,
               bool throwException)
...
int DCMTKFileReader::GetElementFL(unsigned short group,
               unsigned short element,
               float &target,
               bool throwException)
{
...
int DCMTKFileReader::GetElementFLorOB(unsigned short group,
                   unsigned short element,
                   float &target,
                   bool throwException)
{
...
int DCMTKFileReader::GetElementUS(unsigned short group,
               unsigned short element,
...
int DCMTKFileReader::GetElementCSorOB(unsigned short group,
                   unsigned short element,
                   std::string &target,
                   bool throwException)
{
...
int DCMTKFileReader::GetElementPN(unsigned short group,
               unsigned short element,
               std::string &target,
               bool throwException)
{
...
int DCMTKFileReader::GetElementISorOB(unsigned short group,
                   unsigned short element,
                   ::itk::int32_t  &target,
                   bool throwException)
{
...
int DCMTKFileReader::GetElementSQ(unsigned short group,
               unsigned short entry,
               DCMTKSequence &sequence,
               bool throwException)
{
...
int DCMTKFileReader::GetElementUI(unsigned short group,
               unsigned short entry,
               std::string &target,
               bool throwException)
{
...
int DCMTKFileReader::GetElementDA(unsigned short group,
             unsigned short element,
             std::string &target,
             bool throwException)
{
...
int DCMTKFileReader::GetElementTM(unsigned short group,
               unsigned short element,
               std::string &target,
               bool throwException)
{
...
int DCMTKFileReader::GetDirCosArray(double *dircos)
{
...
int DCMTKFileReader::GetDirCosines(vnl_vector<double> &dir1,
...
int DCMTKFileReader::GetSlopeIntercept(double &slope, double &intercept)
{
    slope = 1.0;
    intercept = 0.0;
...
ImageIOBase::IOPixelType DCMTKFileReader::GetImagePixelType()
{
...
ImageIOBase::IOComponentType DCMTKFileReader::GetImageDataType()
{
...
int DCMTKFileReader::GetDimensions(unsigned short &rows, unsigned short &columns)
{
...
int DCMTKFileReader::GetOrigin(double *origin)
{
