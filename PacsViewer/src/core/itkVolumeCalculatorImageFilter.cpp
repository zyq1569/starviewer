...
VolumeCalculatorImageFilter<TInputImage>::VolumeCalculatorImageFilter()
{
...
template<class TInputImage>
DataObject::Pointer VolumeCalculatorImageFilter<TInputImage>::MakeOutput(unsigned int output)
{
    switch (output)
    {
    case 1:
...
template<class TInputImage>
void VolumeCalculatorImageFilter<TInputImage>::GenerateInputRequestedRegion()
{
...
template<class TInputImage>
void VolumeCalculatorImageFilter<TInputImage>::EnlargeOutputRequestedRegion(DataObject *data)
{
...
template<class TInputImage>
void VolumeCalculatorImageFilter<TInputImage>::AllocateOutputs()
{
...
template<class TInputImage>
void VolumeCalculatorImageFilter<TInputImage>::BeforeThreadedGenerateData()
{
...
template<class TInputImage>
void VolumeCalculatorImageFilter<TInputImage>::AfterThreadedGenerateData()
{
    m_VolumeCount = 0;
...
template<class TInputImage>
void VolumeCalculatorImageFilter<TInputImage>::ThreadedGenerateData(const RegionType& outputRegionForThread,
                                                                    int threadId)
{
    PixelType value;
...
void VolumeCalculatorImageFilter<TImage>::PrintSelf(std::ostream& os, Indent indent) const
{
