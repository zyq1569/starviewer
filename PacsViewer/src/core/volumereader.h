...
/**
    ...
    Class in charge of reading the data that must define a volume.
    We pass a pointer to Volume and it is responsible for reading and assigning the appropriate information.
  */
